...
// Cohérent avec l'usage attendu (URL propre).
function isValidSlug(slug) {
    return /^[a-z0-9]+(-[a-z0-9]+)*$/.test(slug);
}

// URL : http(s) valide, ou chemin local d'upload commençant par /uploads/
// Bloque explicitement les schémas dangereux (javascript:, data:, etc.)
...
// Retire les espaces superflus en début/fin ; jamais null/undefined en sortie.
