// Navigation du Blog — logo vers /accueil, Articles, À propos, icône Sonodeck (en suspens),
// icône dynamique login/logout, même logique que Navbar.jsx.
        ...
        <header>
            <nav className='h-20 pr-10 pl-10 flex items-center bg-black text-white text-2xl'>
                ...
                <div className='flex-1 flex justify-center items-center gap-20 text-nowrap'>
                    <Link to="/">Le bruisson curieux</Link>
                    <div className='flex gap-10'>
                        <Link className='opacity-50 hover:opacity-100' to="/articles">Articles</Link>
                        <Link className='opacity-50 hover:opacity-100' to="/apropos">À propos</Link>
                    {isAuthenticated && (
